Quero que te comportes como um programdor backend Senior, e que cries a documentação do projecto que se segue gerando um arwuivo em markdown. 
...
- Sempre que citar alguma dependência do projeto, deixe ela como hyperlink e entre parentes sugere um artigo, para a página oficial daquela dependência
- Organize as dependências em uma sessão em formato de tabela

- crie uma estrutura do projeto com base em grafos de pastas abaixo, e crie uma sessão para explicitar as técnicas utilizadas
...
Lembrando que o arquivo deve ser detalhado tal como o documento sugere em markdown.
